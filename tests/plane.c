...
void *test_plane(void *arg) {
    ...
    ATT_ASSERT(mjb_plane_name(MJB_PLANE_NOT_VALID, false), NULL, "Not valid codespace plane low");
    ATT_ASSERT(mjb_plane_name((mjb_plane)MJB_PLANE_NUM, false), NULL, "Not valid codespace plane high");
