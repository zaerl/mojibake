...
void *test_cjk(void *arg) {
    ...
    ATT_ASSERT(mjb_codepoint_is_cjk_ext(MJB_CJK_EXTENSION_A_START), true, "CJK ext A start");
    ATT_ASSERT(mjb_codepoint_is_cjk_ext(MJB_CJK_EXTENSION_B_START), true, "CJK ext B start");
    ATT_ASSERT(mjb_codepoint_is_cjk_ext(MJB_CJK_EXTENSION_C_START), true, "CJK ext C start");
    ATT_ASSERT(mjb_codepoint_is_cjk_ext(MJB_CJK_EXTENSION_D_START), true, "CJK ext D start");
    ATT_ASSERT(mjb_codepoint_is_cjk_ext(MJB_CJK_EXTENSION_E_START), true, "CJK ext E start");
    ATT_ASSERT(mjb_codepoint_is_cjk_ext(MJB_CJK_EXTENSION_F_START), true, "CJK ext F start");
    ATT_ASSERT(mjb_codepoint_is_cjk_ext(MJB_CJK_EXTENSION_G_START), true, "CJK ext G start");
    ATT_ASSERT(mjb_codepoint_is_cjk_ext(MJB_CJK_EXTENSION_H_START), true, "CJK ext H start");
