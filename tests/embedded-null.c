...
int test_embedded_null(void *arg) {
    ...
    ATT_ASSERT(mjb_string_length(utf8_with_nulls, 5, MJB_ENC_UTF_8), 5,
        "UTF-8: A\\0B\\0C = 5 codepoints (NULL as data)")
#else
    ATT_ASSERT(mjb_string_length(utf8_with_nulls, 5, MJB_ENC_UTF_8), 1,
...
#ifdef MJB_DANGEROUSLY_ALLOW_EMBEDDED_NULLS
    ATT_ASSERT(mjb_string_length(utf8_hello_null_world, 11, MJB_ENC_UTF_8), 11,
        "UTF-8: Hello\\0World = 11 codepoints (with macro)")
#else
    ATT_ASSERT(mjb_string_length(utf8_hello_null_world, 11, MJB_ENC_UTF_8), 5,
...
#ifdef MJB_DANGEROUSLY_ALLOW_EMBEDDED_NULLS
    ATT_ASSERT(mjb_string_length(utf8_only_nulls, 3, MJB_ENC_UTF_8), 3,
        "UTF-8: \\0\\0\\0 = 3 codepoints (with macro)")
#else
    ATT_ASSERT(mjb_string_length(utf8_only_nulls, 3, MJB_ENC_UTF_8), 0,
...
#ifdef MJB_DANGEROUSLY_ALLOW_EMBEDDED_NULLS
    ATT_ASSERT(mjb_string_length(utf8_null_prefix, 4, MJB_ENC_UTF_8), 4,
        "UTF-8: \\0ABC = 4 codepoints (with macro)")
#else
    ATT_ASSERT(mjb_string_length(utf8_null_prefix, 4, MJB_ENC_UTF_8), 0,
...
#ifdef MJB_DANGEROUSLY_ALLOW_EMBEDDED_NULLS
    ATT_ASSERT(mjb_string_length(utf8_multibyte_nulls, 7, MJB_ENC_UTF_8), 4,
        "UTF-8: é\\0ツ\\0 = 4 codepoints (with macro)")
#else
    ATT_ASSERT(mjb_string_length(utf8_multibyte_nulls, 7, MJB_ENC_UTF_8), 1,
...
#ifdef MJB_DANGEROUSLY_ALLOW_EMBEDDED_NULLS
    ATT_ASSERT(mjb_string_length(utf16le_with_null, 6, MJB_ENC_UTF_16LE), 3,
        "UTF-16LE: A\\0B = 3 codepoints (with macro)")
#else
    ATT_ASSERT(mjb_string_length(utf16le_with_null, 6, MJB_ENC_UTF_16LE), 1,
...
#else
    ATT_ASSERT(mjb_string_length(utf16le_hello_null_exclaim, 14, MJB_ENC_UTF_16LE), 5,
...
#ifdef MJB_DANGEROUSLY_ALLOW_EMBEDDED_NULLS
    ATT_ASSERT(mjb_string_length(utf16le_multiple_nulls, 8, MJB_ENC_UTF_16LE), 4,
        "UTF-16LE: X\\0\\0Y = 4 codepoints (with macro)")
#else
    ATT_ASSERT(mjb_string_length(utf16le_multiple_nulls, 8, MJB_ENC_UTF_16LE), 1,
...
#ifdef MJB_DANGEROUSLY_ALLOW_EMBEDDED_NULLS
    ATT_ASSERT(mjb_string_length(utf16be_with_null, 6, MJB_ENC_UTF_16BE), 3,
        "UTF-16BE: A\\0B = 3 codepoints (with macro)")
#else
    ATT_ASSERT(mjb_string_length(utf16be_with_null, 6, MJB_ENC_UTF_16BE), 1,
...
#else
    ATT_ASSERT(mjb_string_length(utf16be_test_null_data, 18, MJB_ENC_UTF_16BE), 4,
...
#ifdef MJB_DANGEROUSLY_ALLOW_EMBEDDED_NULLS
    ATT_ASSERT(mjb_string_length(utf32le_with_null, 12, MJB_ENC_UTF_32LE), 3,
        "UTF-32LE: A\\0B = 3 codepoints (with macro)")
#else
    ATT_ASSERT(mjb_string_length(utf32le_with_null, 12, MJB_ENC_UTF_32LE), 1,
...
#ifdef MJB_DANGEROUSLY_ALLOW_EMBEDDED_NULLS
    ATT_ASSERT(mjb_string_length(utf32le_digits_nulls, 28, MJB_ENC_UTF_32LE), 7,
        "UTF-32LE: 1\\0\\02\\0\\03 = 7 codepoints (with macro)")
#else
    ATT_ASSERT(mjb_string_length(utf32le_digits_nulls, 28, MJB_ENC_UTF_32LE), 1,
...
#ifdef MJB_DANGEROUSLY_ALLOW_EMBEDDED_NULLS
    ATT_ASSERT(mjb_string_length(utf32be_with_null, 12, MJB_ENC_UTF_32BE), 3,
        "UTF-32BE: A\\0B = 3 codepoints (with macro)")
#else
    ATT_ASSERT(mjb_string_length(utf32be_with_null, 12, MJB_ENC_UTF_32BE), 1,
...
#ifdef MJB_DANGEROUSLY_ALLOW_EMBEDDED_NULLS
    ATT_ASSERT(mjb_string_length(utf32be_emoji_null, 12, MJB_ENC_UTF_32BE), 3,
        "UTF-32BE: 🤝\\0🌍 = 3 codepoints (with macro)")
#else
    ATT_ASSERT(mjb_string_length(utf32be_emoji_null, 12, MJB_ENC_UTF_32BE), 1,
...
#ifdef MJB_DANGEROUSLY_ALLOW_EMBEDDED_NULLS
    ATT_ASSERT(mjb_string_length(utf8_boundary, 2, MJB_ENC_UTF_8), 2,
        "UTF-8: A\\0 = 2 codepoints (with macro)")
#else
    ATT_ASSERT(mjb_string_length(utf8_boundary, 2, MJB_ENC_UTF_8), 1,
...
#ifdef MJB_DANGEROUSLY_ALLOW_EMBEDDED_NULLS
    ATT_ASSERT(mjb_string_length(utf8_empty_then_data, 4, MJB_ENC_UTF_8), 4,
        "UTF-8: \\0ABC = 4 codepoints (with macro)")
#else
    ATT_ASSERT(mjb_string_length(utf8_empty_then_data, 4, MJB_ENC_UTF_8), 0,
        "UTF-8: \\0ABC = 0 codepoints (starts with NULL)")
#endif
