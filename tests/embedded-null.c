...
int test_embedded_null(void *arg) {
...
#else
    ATT_ASSERT(mjb_count_codepoints(utf8_with_nulls, 5, MJB_ENC_UTF_8), 1,
...
#else
    ATT_ASSERT(mjb_count_codepoints(utf8_hello_null_world, 11, MJB_ENC_UTF_8), 5,
...
#else
    ATT_ASSERT(mjb_count_codepoints(utf8_only_nulls, 3, MJB_ENC_UTF_8), 0,
...
#else
    ATT_ASSERT(mjb_count_codepoints(utf8_null_prefix, 4, MJB_ENC_UTF_8), 0,
...
#else
    ATT_ASSERT(mjb_count_codepoints(utf8_multibyte_nulls, 7, MJB_ENC_UTF_8), 1,
...
#else
    ATT_ASSERT(mjb_count_codepoints(utf16le_with_null, 6, MJB_ENC_UTF_16LE), 1,
...
#else
    ATT_ASSERT(mjb_count_codepoints(utf16le_hello_null_exclaim, 14, MJB_ENC_UTF_16LE), 5,
...
#else
    ATT_ASSERT(mjb_count_codepoints(utf16le_multiple_nulls, 8, MJB_ENC_UTF_16LE), 1,
...
#else
    ATT_ASSERT(mjb_count_codepoints(utf16be_with_null, 6, MJB_ENC_UTF_16BE), 1,
...
#else
    ATT_ASSERT(mjb_count_codepoints(utf16be_test_null_data, 18, MJB_ENC_UTF_16BE), 4,
...
#else
    ATT_ASSERT(mjb_count_codepoints(utf32le_with_null, 12, MJB_ENC_UTF_32LE), 1,
...
#else
    ATT_ASSERT(mjb_count_codepoints(utf32le_digits_nulls, 28, MJB_ENC_UTF_32LE), 1,
...
#else
    ATT_ASSERT(mjb_count_codepoints(utf32be_with_null, 12, MJB_ENC_UTF_32BE), 1,
...
#else
    ATT_ASSERT(mjb_count_codepoints(utf32be_emoji_null, 12, MJB_ENC_UTF_32BE), 1,
...
#else
    ATT_ASSERT(mjb_count_codepoints(utf8_boundary, 2, MJB_ENC_UTF_8), 1,
    ...
    ATT_ASSERT(mjb_count_codepoints(utf8_empty_then_data, 4, MJB_ENC_UTF_8), 4,
        "UTF-8: \\0ABC = 4 codepoints (with macro)")
#else
    ATT_ASSERT(mjb_count_codepoints(utf8_empty_then_data, 4, MJB_ENC_UTF_8), 0,
        "UTF-8: \\0ABC = 0 codepoints (starts with NULL)")
#endif
