...
int test_identifier(void *arg) {
    ...
    ATT_ASSERT(mjb_string_is_identifier("hello", 5, MJB_ENC_UTF_8, MJB_IDENTIFIER_DEFAULT), true,
        "Identifier: 'hello'")
    ATT_ASSERT(mjb_string_is_identifier("_x", 2, MJB_ENC_UTF_8, MJB_IDENTIFIER_DEFAULT), false,
        "Identifier: '_x' (_ not ID_Start)")
    ATT_ASSERT(mjb_string_is_identifier("hello123", 8, MJB_ENC_UTF_8, MJB_IDENTIFIER_DEFAULT), true,
        "Identifier: 'hello123'")
    ATT_ASSERT(mjb_string_is_identifier("hello_world", 11, MJB_ENC_UTF_8, MJB_IDENTIFIER_DEFAULT),
        true, "Identifier: 'hello_world'")
    ATT_ASSERT(mjb_string_is_identifier("123abc", 6, MJB_ENC_UTF_8, MJB_IDENTIFIER_DEFAULT), false,
        "Identifier: '123abc' (digit start)")
    ATT_ASSERT(mjb_string_is_identifier("hello world", 11, MJB_ENC_UTF_8, MJB_IDENTIFIER_DEFAULT),
