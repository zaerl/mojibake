...
int test_filter(void *arg) {
    ...
    ATT_ASSERT_STATUS(mjb_string_filter("", 0, enc, MJB_FILTER_NONE, enc, &result), MJB_STATUS_OK,
        "Filter empty string")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(spaces, strlen(spaces), enc, MJB_FILTER_SPACES, enc,
                          &result),
        MJB_STATUS_OK, "Filter spaces")
    ATT_ASSERT(result.output, (char *)"                 ", "Filter spaces output")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(spaces, strlen(spaces), enc,
                          (mjb_filter)(MJB_FILTER_NORMALIZE | MJB_FILTER_SPACES), enc, &result),
        MJB_STATUS_OK, "Filter spaces and normalize")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(multiple_spaces, strlen(multiple_spaces), enc,
                          MJB_FILTER_COLLAPSE_SPACES, enc, &result),
        MJB_STATUS_OK, "Collapse multiple spaces")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(mixed_whitespace, strlen(mixed_whitespace), enc,
                          MJB_FILTER_COLLAPSE_SPACES, enc, &result),
        MJB_STATUS_OK, "Collapse mixed whitespace")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(leading_whitespace, strlen(leading_whitespace), enc,
                          MJB_FILTER_COLLAPSE_SPACES, enc, &result),
        MJB_STATUS_OK, "Collapse leading whitespace")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(trailing_whitespace, strlen(trailing_whitespace), enc,
                          MJB_FILTER_COLLAPSE_SPACES, enc, &result),
        MJB_STATUS_OK, "Collapse trailing whitespace")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(unicode_multiple_spaces, strlen(unicode_multiple_spaces),
                          enc, (mjb_filter)(MJB_FILTER_SPACES | MJB_FILTER_COLLAPSE_SPACES), enc,
                          &result),
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(complex_whitespace, strlen(complex_whitespace), enc,
                          MJB_FILTER_COLLAPSE_SPACES, enc, &result),
        MJB_STATUS_OK, "Collapse complex whitespace")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(only_whitespace, strlen(only_whitespace), enc,
                          MJB_FILTER_COLLAPSE_SPACES, enc, &result),
        MJB_STATUS_OK, "Collapse only whitespace")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(single_spaces, strlen(single_spaces), enc,
                          MJB_FILTER_COLLAPSE_SPACES, enc, &result),
        MJB_STATUS_OK, "No collapse needed")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(arabic_indic_digit, strlen(arabic_indic_digit), enc,
                          MJB_FILTER_NUMERIC, enc, &result),
        MJB_STATUS_OK, "Filter arabic indic digit")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(ordinary_combining, strlen(ordinary_combining), enc,
                          MJB_FILTER_LIMIT_COMBINING, enc, &result),
        MJB_STATUS_OK, "Limit combining ordinary accent")
    ...
    const char *expected_stacked_combining = "a"
                                             ...
                                             "\xCC\x83" // U+0303 COMBINING TILDE
                                             "b";
    ATT_ASSERT_STATUS(mjb_string_filter(stacked_combining, strlen(stacked_combining), enc,
                          MJB_FILTER_LIMIT_COMBINING, enc, &result),
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(split_by_removed_control, strlen(split_by_removed_control),
                          enc, (mjb_filter)(MJB_FILTER_CONTROLS | MJB_FILTER_LIMIT_COMBINING), enc,
                          &result),
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(valid_utf8, strlen(valid_utf8), enc, MJB_FILTER_NONE, enc,
                          &result),
        MJB_STATUS_OK, "UTF8: Valid string")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(valid_multibyte, strlen(valid_multibyte), enc,
                          MJB_FILTER_NONE, enc, &result),
        MJB_STATUS_OK, "UTF8: Valid multibyte")
    ...
    const char *single_invalid = "A\xC0"
                                 "B"; // 0xC0 is invalid
    const char *expected_single = "A\xEF\xBF\xBD"
                                  "B";
    ATT_ASSERT_STATUS(mjb_string_filter(single_invalid, strlen(single_invalid), enc,
                          MJB_FILTER_NONE, enc, &result),
        MJB_STATUS_OK, "UTF8: Single invalid byte")
    ...
    const char *multiple_invalid = "A\xC0"
                                   "B\xC1"
                                   "C";
    const char *expected_multiple = "A\xEF\xBF\xBD"
                                    "B\xEF\xBF\xBD"
                                    "C";
    ATT_ASSERT_STATUS(mjb_string_filter(multiple_invalid, strlen(multiple_invalid), enc,
                          MJB_FILTER_NONE, enc, &result),
        MJB_STATUS_OK, "UTF8: Multiple invalid bytes")
    ...
    const char *invalid_2byte = "A\xC0\xAF"
                                "B"; // Invalid 2-byte sequence
    const char *expected_2byte = "A\xEF\xBF\xBD"
                                 "B";
    ATT_ASSERT_STATUS(mjb_string_filter(invalid_2byte, strlen(invalid_2byte), enc, MJB_FILTER_NONE,
                          enc, &result),
        MJB_STATUS_OK, "UTF8: Invalid 2-byte sequence")
    ...
    const char *invalid_3byte = "A\xE0\x80\x80"
                                "B"; // Invalid 3-byte (overlong)
    const char *expected_3byte = "A\xEF\xBF\xBD"
                                 "B";
    ATT_ASSERT_STATUS(mjb_string_filter(invalid_3byte, strlen(invalid_3byte), enc, MJB_FILTER_NONE,
                          enc, &result),
        MJB_STATUS_OK, "UTF8: Invalid 3-byte sequence")
    ...
    const char *invalid_4byte = "A\xF5\x80\x80\x80"
                                "B"; // 0xF5 is invalid start
    const char *expected_4byte = "A\xEF\xBF\xBD"
                                 "B";
    ATT_ASSERT_STATUS(mjb_string_filter(invalid_4byte, strlen(invalid_4byte), enc, MJB_FILTER_NONE,
                          enc, &result),
        MJB_STATUS_OK, "UTF8: Invalid 4-byte sequence")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(truncated, 6, enc, MJB_FILTER_NONE, enc, &result),
    ...
    const char *invalid_continuation = "A\x80"
                                       "B"; // 0x80 without lead byte
    const char *expected_continuation = "A\xEF\xBF\xBD"
                                        "B";
    ATT_ASSERT_STATUS(mjb_string_filter(invalid_continuation, strlen(invalid_continuation), enc,
                          MJB_FILTER_NONE, enc, &result),
        MJB_STATUS_OK, "UTF8: Invalid continuation")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(mixed_valid_invalid, strlen(mixed_valid_invalid), enc,
                          MJB_FILTER_NONE, enc, &result),
        MJB_STATUS_OK, "UTF8: Mixed valid/invalid")
    ...
    const char *invalid_start = "\xC0"
                                "Hello";
    const char *expected_start = "\xEF\xBF\xBD"
                                 "Hello";
    ATT_ASSERT_STATUS(mjb_string_filter(invalid_start, strlen(invalid_start), enc, MJB_FILTER_NONE,
                          enc, &result),
        MJB_STATUS_OK, "UTF8: Invalid at start")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(invalid_end, 6, enc, MJB_FILTER_NONE, enc, &result),
    ...
    const char *consecutive_invalid = "A\xC0\xC1\xC2"
                                      "B"; // Three consecutive invalid bytes
    const char *expected_consecutive = "A\xEF\xBF\xBD"
                                       "B";
    ATT_ASSERT_STATUS(mjb_string_filter(consecutive_invalid, strlen(consecutive_invalid), enc,
                          MJB_FILTER_NONE, enc, &result),
        MJB_STATUS_OK, "UTF8: Consecutive invalid bytes")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(overlong_slash, 2, enc, MJB_FILTER_NONE, enc, &result),
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(only_invalid, 3, enc, MJB_FILTER_NONE, enc, &result),
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(invalid_then_valid, 4, enc, MJB_FILTER_NONE, enc, &result),
    ...
    const char *missing_continuation_2 = "A\xC2"
                                         "B"; // C2 needs continuation
    const char *expected_missing_2 = "A\xEF\xBF\xBD"
                                     "B";
    ATT_ASSERT_STATUS(mjb_string_filter(missing_continuation_2, strlen(missing_continuation_2), enc,
                          MJB_FILTER_NONE, enc, &result),
        MJB_STATUS_OK, "UTF8: Missing continuation 2-byte")
    ...
    const char *missing_continuation_3 = "A\xE0\xA0"
                                         "B"; // E0 A0 needs another byte
    const char *expected_missing_3 = "A\xEF\xBF\xBD"
                                     "B";
    ATT_ASSERT_STATUS(mjb_string_filter(missing_continuation_3, strlen(missing_continuation_3), enc,
                          MJB_FILTER_NONE, enc, &result),
        MJB_STATUS_OK, "UTF8: Missing continuation 3-byte")
    ...
    const char *replacement_then_valid = "\xC0"
                                         "Hello";
    const char *expected_replacement_valid = "\xEF\xBF\xBD"
                                             "Hello";
    ...
    const char *separate_invalid = "A\xC0"
                                   "B\xE0\x80"
                                   "C\xF5\x80"
                                   "D";
    const char *expected_separate = "A\xEF\xBF\xBD"
                                    ...
                                    "C\xEF\xBF\xBD"
                                    "D";
    ATT_ASSERT_STATUS(mjb_string_filter(separate_invalid, strlen(separate_invalid), enc,
                          MJB_FILTER_NONE, enc, &result),
        MJB_STATUS_OK, "UTF8: Separate invalid sequences")
