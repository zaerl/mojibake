...
int test_filter(void *arg) {
    ...
    ATT_ASSERT_STATUS(mjb_filter("", 0, enc, MJB_FILTER_NONE, enc, NULL),
        MJB_STATUS_INVALID_ARGUMENT, "Filter rejects NULL result")

    ATT_ASSERT_STATUS(mjb_filter("", 0, enc, MJB_FILTER_NONE, enc, &result), MJB_STATUS_OK,
        "Filter empty string")
    ...
    ATT_ASSERT_STATUS(mjb_filter("", 0, enc, MJB_FILTER_NORMALIZE, enc, &result),
    ...
    ATT_ASSERT_STATUS(mjb_filter("   ", 0, enc, MJB_FILTER_SPACES, enc, &result),
        MJB_STATUS_OK, "Filter spaces")
    ATT_ASSERT(result.output, (char *)"   ", "Filter spaces output")
    mjb_result_free(&result);

    ATT_ASSERT_STATUS(mjb_filter("A", 1, enc, MJB_FILTER_NONE, MJB_ENC_UTF_16LE, &result),
    ...
    ATT_ASSERT_STATUS(mjb_filter("A", 1, enc, MJB_FILTER_NORMALIZE, MJB_ENC_UTF_16LE,
                          &result),
    ...
    ATT_ASSERT_STATUS(mjb_filter(spaces, strlen(spaces), enc, MJB_FILTER_SPACES, enc,
                          &result),
        MJB_STATUS_OK, "Filter spaces")
    ATT_ASSERT(result.output, (char *)"                 ", "Filter spaces output")
    ...
    ATT_ASSERT_STATUS(mjb_filter(multiple_spaces, strlen(multiple_spaces), enc,
    ...
    ATT_ASSERT_STATUS(mjb_filter(mixed_whitespace, strlen(mixed_whitespace), enc,
    ...
    ATT_ASSERT_STATUS(mjb_filter(leading_whitespace, strlen(leading_whitespace), enc,
    ...
    ATT_ASSERT_STATUS(mjb_filter(trailing_whitespace, strlen(trailing_whitespace), enc,
    ...
    ATT_ASSERT_STATUS(mjb_filter(complex_whitespace, strlen(complex_whitespace), enc,
    ...
    ATT_ASSERT_STATUS(mjb_filter(only_whitespace, strlen(only_whitespace), enc,
    ...
    ATT_ASSERT_STATUS(mjb_filter(single_spaces, strlen(single_spaces), enc,
    ...
    ATT_ASSERT_STATUS(mjb_filter(controls, strlen(controls), enc, MJB_FILTER_CONTROLS, enc,
    ...
    ATT_ASSERT_STATUS(mjb_filter(numeric, strlen(numeric), enc, MJB_FILTER_NUMERIC, enc,
    ...
    ATT_ASSERT_STATUS(mjb_filter(arabic_indic_digit, strlen(arabic_indic_digit), enc,
        MJB_FILTER_NUMERIC, enc, &result), MJB_STATUS_OK, "Filter arabic indic digit")
    ...
    ATT_ASSERT_STATUS(mjb_filter(ordinary_combining, strlen(ordinary_combining), enc,
        MJB_FILTER_LIMIT_COMBINING, enc, &result), MJB_STATUS_OK, "Limit combining ordinary accent")
    ...
    ATT_ASSERT_STATUS(mjb_filter(stacked_combining, strlen(stacked_combining), enc,
    ...
    ATT_ASSERT_STATUS(mjb_filter(valid_utf8, strlen(valid_utf8), enc, MJB_FILTER_NONE, enc,
    ...
    ATT_ASSERT_STATUS(mjb_filter(valid_multibyte, strlen(valid_multibyte), enc,
    ...
    ATT_ASSERT_STATUS(mjb_filter(single_invalid, strlen(single_invalid), enc,
        MJB_FILTER_NONE, enc, &result), MJB_STATUS_OK, "UTF8: Single invalid byte")
    ...
    ATT_ASSERT_STATUS(mjb_filter(multiple_invalid, strlen(multiple_invalid), enc,
        MJB_FILTER_NONE, enc, &result), MJB_STATUS_OK, "UTF8: Multiple invalid bytes")
    ...
    ATT_ASSERT_STATUS(mjb_filter(invalid_2byte, strlen(invalid_2byte), enc, MJB_FILTER_NONE,
    ...
    ATT_ASSERT_STATUS(mjb_filter(invalid_3byte, strlen(invalid_3byte), enc, MJB_FILTER_NONE,
    ...
    // clang-format on
    ATT_ASSERT_STATUS(mjb_filter(invalid_4byte, strlen(invalid_4byte), enc, MJB_FILTER_NONE,
    ...
    ATT_ASSERT_STATUS(mjb_filter(truncated, 6, enc, MJB_FILTER_NONE, enc, &result),
    ...
    // clang-format on
    ATT_ASSERT_STATUS(mjb_filter(invalid_continuation, strlen(invalid_continuation), enc,
    ...
    ATT_ASSERT_STATUS(mjb_filter(mixed_valid_invalid, strlen(mixed_valid_invalid), enc,
    ...
    // clang-format on
    ATT_ASSERT_STATUS(mjb_filter(invalid_start, strlen(invalid_start), enc, MJB_FILTER_NONE,
    ...
    ATT_ASSERT_STATUS(mjb_filter(invalid_end, 6, enc, MJB_FILTER_NONE, enc, &result),
    ...
    // clang-format on
    ATT_ASSERT_STATUS(mjb_filter(consecutive_invalid, strlen(consecutive_invalid), enc,
        MJB_FILTER_NONE, enc, &result), MJB_STATUS_OK, "UTF8: Consecutive invalid bytes")
    ...
    ATT_ASSERT_STATUS(mjb_filter(overlong_slash, 2, enc, MJB_FILTER_NONE, enc, &result),
    ...
    ATT_ASSERT_STATUS(mjb_filter(only_invalid, 3, enc, MJB_FILTER_NONE, enc, &result),
    ...
    ATT_ASSERT_STATUS(mjb_filter(invalid_then_valid, 4, enc, MJB_FILTER_NONE, enc, &result),
    ...
    // clang-format on
    ATT_ASSERT_STATUS(mjb_filter(missing_continuation_2, strlen(missing_continuation_2), enc,
    ...
    // clang-format on
    ATT_ASSERT_STATUS(mjb_filter(missing_continuation_3, strlen(missing_continuation_3), enc,
    ...
    // clang-format on
    ATT_ASSERT_STATUS(mjb_filter(replacement_then_valid, strlen(replacement_then_valid), enc,
    ...
    // clang-format on
    ATT_ASSERT_STATUS(mjb_filter(separate_invalid, strlen(separate_invalid), enc,
        MJB_FILTER_NONE, enc, &result), MJB_STATUS_OK, "UTF8: Separate invalid sequences")
