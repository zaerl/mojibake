 ...
 */
 ...
 int test_filter(void *arg) {
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(NULL, 1, enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_INVALID_ARGUMENT,
        "Filter rejects NULL buffer")
    ATT_ASSERT_STATUS(mjb_string_filter("", 0, enc, enc, MJB_FILTER_NONE, NULL), MJB_STATUS_INVALID_ARGUMENT,
        "Filter rejects NULL result")

    ATT_ASSERT_STATUS(mjb_string_filter("", 0, enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "Filter empty string")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter("", 0, enc, enc, MJB_FILTER_NORMALIZE, &result), MJB_STATUS_OK, "Filter normalize empty string")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter("   ", 0, enc, enc, MJB_FILTER_SPACES, &result), MJB_STATUS_OK, "Filter spaces")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(spaces, strlen(spaces), enc, enc, MJB_FILTER_SPACES, &result), MJB_STATUS_OK, "Filter spaces")
    ATT_ASSERT(result.output, (char*)"                 ", "Filter spaces output")
    ATT_ASSERT(result.output_size, 17, "Filter spaces output size")
    FREE_RESULT

    ATT_ASSERT_STATUS(mjb_string_filter(spaces, strlen(spaces), enc, enc, (mjb_filter)(MJB_FILTER_NORMALIZE | MJB_FILTER_SPACES), &result), MJB_STATUS_OK, "Filter spaces and normalize")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(multiple_spaces, strlen(multiple_spaces), enc, enc, MJB_FILTER_COLLAPSE_SPACES, &result), MJB_STATUS_OK, "Collapse multiple spaces")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(mixed_whitespace, strlen(mixed_whitespace), enc, enc, MJB_FILTER_COLLAPSE_SPACES, &result), MJB_STATUS_OK, "Collapse mixed whitespace")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(leading_whitespace, strlen(leading_whitespace), enc, enc, MJB_FILTER_COLLAPSE_SPACES, &result), MJB_STATUS_OK, "Collapse leading whitespace")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(trailing_whitespace, strlen(trailing_whitespace), enc, enc, MJB_FILTER_COLLAPSE_SPACES, &result), MJB_STATUS_OK, "Collapse trailing whitespace")
    ...
    const char *unicode_multiple_spaces =
        ...
        "world";
    ATT_ASSERT_STATUS(mjb_string_filter(unicode_multiple_spaces, strlen(unicode_multiple_spaces), enc, enc, (mjb_filter)(MJB_FILTER_SPACES | MJB_FILTER_COLLAPSE_SPACES), &result), MJB_STATUS_OK, "Collapse Unicode spaces")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(complex_whitespace, strlen(complex_whitespace), enc, enc, MJB_FILTER_COLLAPSE_SPACES, &result), MJB_STATUS_OK, "Collapse complex whitespace")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(only_whitespace, strlen(only_whitespace), enc, enc, MJB_FILTER_COLLAPSE_SPACES, &result), MJB_STATUS_OK, "Collapse only whitespace")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(single_spaces, strlen(single_spaces), enc, enc, MJB_FILTER_COLLAPSE_SPACES, &result), MJB_STATUS_OK, "No collapse needed")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(controls, strlen(controls), enc, enc, MJB_FILTER_CONTROLS, &result), MJB_STATUS_OK, "Filter controls")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(numeric, strlen(numeric), enc, enc, MJB_FILTER_NUMERIC, &result), MJB_STATUS_OK, "Filter numeric")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(arabic_indic_digit, strlen(arabic_indic_digit), enc, enc, MJB_FILTER_NUMERIC, &result), MJB_STATUS_OK, "Filter arabic indic digit")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(valid_utf8, strlen(valid_utf8), enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "UTF8: Valid string")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(valid_multibyte, strlen(valid_multibyte), enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "UTF8: Valid multibyte")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(single_invalid, strlen(single_invalid), enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "UTF8: Single invalid byte")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(multiple_invalid, strlen(multiple_invalid), enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "UTF8: Multiple invalid bytes")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(invalid_2byte, strlen(invalid_2byte), enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "UTF8: Invalid 2-byte sequence")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(invalid_3byte, strlen(invalid_3byte), enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "UTF8: Invalid 3-byte sequence")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(invalid_4byte, strlen(invalid_4byte), enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "UTF8: Invalid 4-byte sequence")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(truncated, 6, enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "UTF8: Truncated sequence")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(invalid_continuation, strlen(invalid_continuation), enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "UTF8: Invalid continuation")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(mixed_valid_invalid, strlen(mixed_valid_invalid), enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "UTF8: Mixed valid/invalid")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(invalid_start, strlen(invalid_start), enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "UTF8: Invalid at start")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(invalid_end, 6, enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "UTF8: Invalid at end")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(consecutive_invalid, strlen(consecutive_invalid), enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "UTF8: Consecutive invalid bytes")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(overlong_slash, 2, enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "UTF8: Overlong encoding")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(only_invalid, 3, enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "UTF8: Only invalid bytes")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(invalid_then_valid, 4, enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "UTF8: Invalid then valid")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(missing_continuation_2, strlen(missing_continuation_2), enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "UTF8: Missing continuation 2-byte")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(missing_continuation_3, strlen(missing_continuation_3), enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "UTF8: Missing continuation 3-byte")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(replacement_then_valid, strlen(replacement_then_valid), enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "UTF8: Replacement then valid")
    ...
    ATT_ASSERT_STATUS(mjb_string_filter(separate_invalid, strlen(separate_invalid), enc, enc, MJB_FILTER_NONE, &result), MJB_STATUS_OK, "UTF8: Separate invalid sequences")
