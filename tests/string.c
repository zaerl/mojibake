...
int test_string(void *arg) {
    ...
    ATT_ASSERT(mjb_string_length(utf16le_hello_accents, 2, enc), 1, "UTF-16LE length: Héllö (1 max value)")
    ...
    ATT_ASSERT(mjb_string_length(utf16be_hello_accents, 2, enc), 1, "UTF-16BE length: Héllö (1 max value)")
    ...
    ATT_ASSERT(mjb_string_length(utf32le_hello_accents, 20, enc), 5,
        "UTF-32LE length: Héllö")
    ATT_ASSERT(mjb_string_length(utf32le_hello_accents, 16, enc), 4,
        "UTF-32LE length: Héllö")
    ATT_ASSERT(mjb_string_length(utf32le_hello_accents, 8, enc), 2,
        "UTF-32LE length: Héllö")
    ...
    ATT_ASSERT(mjb_string_length(utf32le_hello_katakana, 28, enc), 7,
        "UTF-32LE length: Hèllõ ツ")
    ATT_ASSERT(mjb_string_length(utf32le_hello_katakana, 20, enc), 5,
        "UTF-32LE length: Hèllõ ツ")

    const char utf32le_konnichiwa[] =
        "\x93\x30\0\0\x93\x30\0\0\x6B\x30\0\0\x61\x30\0\0\x6F\x30\0\0";
    ATT_ASSERT(mjb_string_length(utf32le_konnichiwa, 20, enc), 5,
    ...
    ATT_ASSERT(mjb_string_length(utf32le_geia_sou, 32, enc), 8,
    ...
    ATT_ASSERT(mjb_string_length(utf32be_hello_accents, 20, enc), 5,
        "UTF-32BE length: Héllö")
    ATT_ASSERT(mjb_string_length(utf32be_hello_accents, 16, enc), 4,
        "UTF-32BE length: Héllö")
    ATT_ASSERT(mjb_string_length(utf32be_hello_accents, 8, enc), 2,
        "UTF-32BE length: Héllö")
    ...
    ATT_ASSERT(mjb_string_length(utf32be_hello_katakana, 28, enc), 7,
        "UTF-32BE length: Hèllõ ツ")
    ATT_ASSERT(mjb_string_length(utf32be_hello_katakana, 20, enc), 5,
        "UTF-32BE length: Hèllõ ツ")

    const char utf32be_konnichiwa[] =
        "\0\0\x30\x93\0\0\x30\x93\0\0\x30\x6B\0\0\x30\x61\0\0\x30\x6F";
    ATT_ASSERT(mjb_string_length(utf32be_konnichiwa, 20, enc), 5,
    ...
    ATT_ASSERT(mjb_string_length(utf32be_geia_sou, 32, enc), 8,
