...
void *test_display(void *arg) {
    ...
    ATT_ASSERT_STATUS(mjb_display_width("A", 1, MJB_ENCODING_UTF_8, MJB_WIDTH_CONTEXT_AUTO, NULL),
        MJB_STATUS_INVALID_ARGUMENT, "NULL width pointer")
    ATT_ASSERT_STATUS(mjb_display_width(NULL, 1, MJB_ENCODING_UTF_8, MJB_WIDTH_CONTEXT_AUTO, &sw),
        MJB_STATUS_INVALID_ARGUMENT, "NULL display buffer")

    ATT_ASSERT_STATUS(mjb_display_width("", 0, MJB_ENCODING_UTF_8, MJB_WIDTH_CONTEXT_AUTO, &sw),
        MJB_STATUS_OK, "Empty string")
    ATT_ASSERT(sw, 0, "Empty string")

    ATT_ASSERT_STATUS(mjb_display_width(" ", 1, MJB_ENCODING_UTF_8, MJB_WIDTH_CONTEXT_AUTO, &sw),
        MJB_STATUS_OK, "Space")
    ATT_ASSERT(sw, 1, "Space")

    // Test combining marks (should be zero width)
    ATT_ASSERT_STATUS(mjb_display_width("e\xCC\x81", 3, MJB_ENCODING_UTF_8, MJB_WIDTH_CONTEXT_AUTO,
        &sw), MJB_STATUS_OK, "e + combining acute")
    ATT_ASSERT(sw, 1, "e + combining acute (é)")

    ATT_ASSERT_STATUS(mjb_display_width("\xCC\x81", 2, MJB_ENCODING_UTF_8, MJB_WIDTH_CONTEXT_AUTO,
        &sw), MJB_STATUS_OK, "Combining acute alone")
    ATT_ASSERT(sw, 0, "Combining acute alone")

    // Test zero-width format characters
    ATT_ASSERT_STATUS(mjb_display_width("\xE2\x80\x8B", 3, MJB_ENCODING_UTF_8,
        MJB_WIDTH_CONTEXT_AUTO, &sw), MJB_STATUS_OK, "Zero-width space")
    ATT_ASSERT(sw, 0, "Zero-width space (U+200B)")

    ATT_ASSERT_STATUS(mjb_display_width("\xE2\x80\x8C", 3, MJB_ENCODING_UTF_8,
        MJB_WIDTH_CONTEXT_AUTO, &sw), MJB_STATUS_OK, "Zero-width non-joiner")
    ATT_ASSERT(sw, 0, "Zero-width non-joiner (U+200C)")

    ATT_ASSERT_STATUS(mjb_display_width("\xE2\x80\x8D", 3, MJB_ENCODING_UTF_8,
    ...
    ATT_ASSERT_STATUS(mjb_display_width("\xef\xbc\xa1", 3, MJB_ENCODING_UTF_8,
        MJB_WIDTH_CONTEXT_AUTO, &sw), MJB_STATUS_OK, "Full-width A")
    ATT_ASSERT(sw, 2, "Full-width A (Ａ)")

    // Test mixed strings
    ATT_ASSERT_STATUS(mjb_display_width("Hello", 5, MJB_ENCODING_UTF_8, MJB_WIDTH_CONTEXT_AUTO, &sw),
        MJB_STATUS_OK, "ASCII string")
    ATT_ASSERT(sw, 5, "ASCII string (Hello)")

    ATT_ASSERT_STATUS(mjb_display_width("Hello\xe4\xb8\xad", 8, MJB_ENCODING_UTF_8,
        MJB_WIDTH_CONTEXT_AUTO, &sw), MJB_STATUS_OK, "ASCII + CJK")
    ATT_ASSERT(sw, 7, "ASCII + CJK (Hello中)")

    ATT_ASSERT_STATUS(mjb_display_width("e\xcc\x81\xe4\xb8\xad", 6, MJB_ENCODING_UTF_8,
    ...
    ATT_ASSERT_STATUS(mjb_display_width("\xf0\x9f\x91\x8d", 4, MJB_ENCODING_UTF_8,
    ...
    ATT_ASSERT_STATUS(mjb_display_width("\xe2\x9d\xa4\xef\xb8\x8f", 6, MJB_ENCODING_UTF_8,
    ...
    ATT_ASSERT_STATUS(mjb_display_width("\xf0\x9f\x91\x8b\xf0\x9f\x8f\xbd", 8,
        MJB_ENCODING_UTF_8, MJB_WIDTH_CONTEXT_AUTO, &sw), MJB_STATUS_OK,
    ...
    ATT_ASSERT_STATUS(mjb_display_width(
        ...
        18, MJB_ENCODING_UTF_8, MJB_WIDTH_CONTEXT_AUTO, &sw), MJB_STATUS_OK,
        "Family emoji ZWJ sequence")
    ATT_ASSERT(sw, 6, "Family emoji ZWJ sequence (👨‍👩‍👧) - counts each emoji separately")

    // Auto context with Western text → narrow (1)
    ATT_ASSERT_STATUS(mjb_display_width("Hello \xc2\xa1Hola!", 13, MJB_ENCODING_UTF_8,
    ...
    ATT_ASSERT_STATUS(mjb_display_width("\xe4\xb8\xad\xe6\x96\x87\xc2\xa1\xe4\xb8\xad",
        11, MJB_ENCODING_UTF_8, MJB_WIDTH_CONTEXT_AUTO, &sw), MJB_STATUS_OK,
    ...
    ATT_ASSERT_STATUS(mjb_display_width("\xc2\xa1", 2, MJB_ENCODING_UTF_8,
