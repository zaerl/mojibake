...
static void break_line_callback(const char *buffer, size_t byte_length, unsigned int current_line,
    ...
    while((bt = mjb_next_line_break(buffer, byte_length, MJB_ENC_UTF_8, &state)) !=
        MJB_BT_NOT_SET) {
