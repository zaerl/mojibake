...
ATT_TEST(hangul_composition) {
    ...
    ATT_ASSERT(not_hangul[1].codepoint, 0x42,
        "Single not hangul character should return the same codepoint");
    ...
    ATT_ASSERT(lv_input[1].codepoint, MJB_CODEPOINT_NOT_VALID,
        "Second character should be marked as invalid");
    ...
    ATT_ASSERT(lvt_input[1].codepoint, MJB_CODEPOINT_NOT_VALID,
        "Second character should be marked as invalid");
    ATT_ASSERT(lvt_input[2].codepoint, MJB_CODEPOINT_NOT_VALID,
        "Third character should be marked as invalid");
    ...
    ATT_ASSERT(multi_input[2].codepoint, MJB_CODEPOINT_NOT_VALID,
        "Third character should be marked as invalid");
    ATT_ASSERT(multi_input[3].codepoint, MJB_CODEPOINT_NOT_VALID,
        "Fourth character should be marked as invalid");
    ATT_ASSERT(multi_input[4].codepoint, MJB_CODEPOINT_NOT_VALID,
        "Fifth character should be marked as invalid");
    ...
    ATT_ASSERT(complex_input[3].codepoint, MJB_CODEPOINT_NOT_VALID,
        "Fourth character should be marked as invalid");
    ATT_ASSERT(complex_input[4].codepoint, MJB_CODEPOINT_NOT_VALID,
        "Fifth character should be marked as invalid");
    ATT_ASSERT(complex_input[5].codepoint, MJB_CODEPOINT_NOT_VALID,
        "Sixth character should be marked as invalid");
    ATT_ASSERT(complex_input[6].codepoint, MJB_CODEPOINT_NOT_VALID,
        "Seventh character should be marked as invalid");
    ATT_ASSERT(complex_input[7].codepoint, MJB_CODEPOINT_NOT_VALID,
        "Eighth character should be marked as invalid");
    ATT_ASSERT(complex_input[8].codepoint, MJB_CODEPOINT_NOT_VALID,
        "Ninth character should be marked as invalid");
    ...
    ATT_ASSERT(invalid_t[2].codepoint, MJB_CODEPOINT_NOT_VALID,
        "Third character should be marked as invalid");
    ...
    ATT_ASSERT(boundary_input[1].codepoint, 0xAC00,
        "Second syllable should be first valid Hangul syllable");
    ATT_ASSERT(boundary_input[2].codepoint, MJB_CODEPOINT_NOT_VALID,
        "Third character should be marked as invalid");
    ATT_ASSERT(boundary_input[3].codepoint, MJB_CODEPOINT_NOT_VALID,
        "Fourth character should be marked as invalid");
    ATT_ASSERT(boundary_input[4].codepoint, MJB_CODEPOINT_NOT_VALID,
        "Fifth character should be marked as invalid");
}
