...
3. Fast
4. Self-contained
5. Pass the official Unicode test suites for supported algorithms
...
Mojibake run a total of **1,560,842** tests including all the official tests included in the
standard:
