...
#define MJB_VERSION_NUMBER   0x23 // MAJOR << 8 | MINOR << 4 | REVISION
#define MJB_VERSION_MAJOR    0
#define MJB_VERSION_MINOR    2
#define MJB_VERSION_REVISION 3

#ifdef __EMSCRIPTEN__
    #define MJB_VERSION "0.2.3-WASM"
#else
    #define MJB_VERSION "0.2.3"
#endif
...
MJB_EXPORT int mjb_string_compare(const char *s1, size_t s1_byte_length, const char *s2, size_t s2_byte_length, mjb_encoding encoding, mjb_collation_mode mode);
...
MJB_EXPORT mjb_break_type mjb_segmentation(const char *buffer, size_t byte_length, mjb_encoding encoding, mjb_next_state *state);
