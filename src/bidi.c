...
// From BidiBrackets.txt, Unicode 18.0.0)
...
static const mjb_bidi_bracket_info mjb_bidi_brackets[] = {
    ...
    { 0x2E5C, 0x2E5B, false }, { 0x2E62, 0x2E63, true }, { 0x2E63, 0x2E62, false },
    { 0x3008, 0x3009, true }, { 0x3009, 0x3008, false }, { 0x300A, 0x300B, true },
    { 0x300B, 0x300A, false }, { 0x300C, 0x300D, true }, { 0x300D, 0x300C, false },
    { 0x300E, 0x300F, true }, { 0x300F, 0x300E, false }, { 0x3010, 0x3011, true },
    { 0x3011, 0x3010, false }, { 0x3014, 0x3015, true }, { 0x3015, 0x3014, false },
    { 0x3016, 0x3017, true }, { 0x3017, 0x3016, false }, { 0x3018, 0x3019, true },
    { 0x3019, 0x3018, false }, { 0x301A, 0x301B, true }, { 0x301B, 0x301A, false },
    { 0xFE59, 0xFE5A, true }, { 0xFE5A, 0xFE59, false }, { 0xFE5B, 0xFE5C, true },
    { 0xFE5C, 0xFE5B, false }, { 0xFE5D, 0xFE5E, true }, { 0xFE5E, 0xFE5D, false },
    { 0xFF08, 0xFF09, true }, { 0xFF09, 0xFF08, false }, { 0xFF3B, 0xFF3D, true },
    { 0xFF3D, 0xFF3B, false }, { 0xFF5B, 0xFF5D, true }, { 0xFF5D, 0xFF5B, false },
    { 0xFF5F, 0xFF60, true }, { 0xFF60, 0xFF5F, false }, { 0xFF62, 0xFF63, true },
    { 0xFF63, 0xFF62, false }
};

#define MJB_BIDI_BRACKET_COUNT 130
// clang-format on
...
typedef struct {
    mjb_codepoint cp;
    mjb_codepoint mirror;
} mjb_bidi_mirroring_pair;

// From BidiMirroring.txt, Unicode 18.0.0
// This array is automatically generated. Do not edit.
// clang-format off
static const mjb_bidi_mirroring_pair mjb_bidi_mirroring[] = {
    ...
    { 0x2215, 0x29F5 }, { 0x221D, 0x1DB10 }, { 0x221F, 0x2BFE },
    { 0x2220, 0x29A3 }, { 0x2221, 0x299B }, { 0x2222, 0x29A0 },
    { 0x2224, 0x2AEE }, { 0x223C, 0x223D }, { 0x223D, 0x223C },
    { 0x2243, 0x22CD }, { 0x2245, 0x224C }, { 0x224C, 0x2245 },
    { 0x2252, 0x2253 }, { 0x2253, 0x2252 }, { 0x2254, 0x2255 },
    { 0x2255, 0x2254 }, { 0x2264, 0x2265 }, { 0x2265, 0x2264 },
    { 0x2266, 0x2267 }, { 0x2267, 0x2266 }, { 0x2268, 0x2269 },
    { 0x2269, 0x2268 }, { 0x226A, 0x226B }, { 0x226B, 0x226A },
    { 0x226E, 0x226F }, { 0x226F, 0x226E }, { 0x2270, 0x2271 },
    { 0x2271, 0x2270 }, { 0x2272, 0x2273 }, { 0x2273, 0x2272 },
    { 0x2274, 0x2275 }, { 0x2275, 0x2274 }, { 0x2276, 0x2277 },
    { 0x2277, 0x2276 }, { 0x2278, 0x2279 }, { 0x2279, 0x2278 },
    { 0x227A, 0x227B }, { 0x227B, 0x227A }, { 0x227C, 0x227D },
    { 0x227D, 0x227C }, { 0x227E, 0x227F }, { 0x227F, 0x227E },
    { 0x2280, 0x2281 }, { 0x2281, 0x2280 }, { 0x2282, 0x2283 },
    { 0x2283, 0x2282 }, { 0x2284, 0x2285 }, { 0x2285, 0x2284 },
    { 0x29A9, 0x29A8 }, { 0x29AA, 0x29AB }, { 0x29AB, 0x29AA },
    { 0x29AC, 0x29AD }, { 0x29AD, 0x29AC }, { 0x29AE, 0x29AF },
    { 0x29AF, 0x29AE }, { 0x29B8, 0x2298 }, { 0x29C0, 0x29C1 },
    { 0x29C1, 0x29C0 }, { 0x29C4, 0x29C5 }, { 0x29C5, 0x29C4 },
    { 0x29CF, 0x29D0 }, { 0x29D0, 0x29CF }, { 0x29D1, 0x29D2 },
    { 0x29D2, 0x29D1 }, { 0x29D4, 0x29D5 }, { 0x29D5, 0x29D4 },
    { 0x29D8, 0x29D9 }, { 0x29D9, 0x29D8 }, { 0x29DA, 0x29DB },
    { 0x29DB, 0x29DA }, { 0x29E8, 0x29E9 }, { 0x29E9, 0x29E8 },
    { 0x29F5, 0x2215 }, { 0x29F8, 0x29F9 }, { 0x29F9, 0x29F8 },
    { 0x29FC, 0x29FD }, { 0x29FD, 0x29FC }, { 0x2A2B, 0x2A2C },
    { 0x2A2C, 0x2A2B }, { 0x2A2D, 0x2A2E }, { 0x2A2E, 0x2A2D },
    { 0x2A34, 0x2A35 }, { 0x2A35, 0x2A34 }, { 0x2A3C, 0x2A3D },
    { 0x2A3D, 0x2A3C }, { 0x2A64, 0x2A65 }, { 0x2A65, 0x2A64 },
    { 0x2A79, 0x2A7A }, { 0x2A7A, 0x2A79 }, { 0x2A7B, 0x2A7C },
    { 0x2A7C, 0x2A7B }, { 0x2A7D, 0x2A7E }, { 0x2A7E, 0x2A7D },
    { 0x2A7F, 0x2A80 }, { 0x2A80, 0x2A7F }, { 0x2A81, 0x2A82 },
    { 0x2A82, 0x2A81 }, { 0x2A83, 0x2A84 }, { 0x2A84, 0x2A83 },
    { 0x2A85, 0x2A86 }, { 0x2A86, 0x2A85 }, { 0x2A87, 0x2A88 },
    { 0x2A88, 0x2A87 }, { 0x2A89, 0x2A8A }, { 0x2A8A, 0x2A89 },
    { 0x2A8B, 0x2A8C }, { 0x2A8C, 0x2A8B }, { 0x2A8D, 0x2A8E },
    { 0x2A8E, 0x2A8D }, { 0x2A8F, 0x2A90 }, { 0x2A90, 0x2A8F },
    { 0x2A91, 0x2A92 }, { 0x2A92, 0x2A91 }, { 0x2A93, 0x2A94 },
    { 0x2A94, 0x2A93 }, { 0x2A95, 0x2A96 }, { 0x2A96, 0x2A95 },
    { 0x2A97, 0x2A98 }, { 0x2A98, 0x2A97 }, { 0x2A99, 0x2A9A },
    { 0x2A9A, 0x2A99 }, { 0x2A9B, 0x2A9C }, { 0x2A9C, 0x2A9B },
    { 0x2A9D, 0x2A9E }, { 0x2A9E, 0x2A9D }, { 0x2A9F, 0x2AA0 },
    { 0x2AA0, 0x2A9F }, { 0x2AA1, 0x2AA2 }, { 0x2AA2, 0x2AA1 },
    { 0x2AA6, 0x2AA7 }, { 0x2AA7, 0x2AA6 }, { 0x2AA8, 0x2AA9 },
    { 0x2AA9, 0x2AA8 }, { 0x2AAA, 0x2AAB }, { 0x2AAB, 0x2AAA },
    { 0x2AAC, 0x2AAD }, { 0x2AAD, 0x2AAC }, { 0x2AAF, 0x2AB0 },
    { 0x2AB0, 0x2AAF }, { 0x2AB1, 0x2AB2 }, { 0x2AB2, 0x2AB1 },
    { 0x2AB3, 0x2AB4 }, { 0x2AB4, 0x2AB3 }, { 0x2AB5, 0x2AB6 },
    { 0x2AB6, 0x2AB5 }, { 0x2AB7, 0x2AB8 }, { 0x2AB8, 0x2AB7 },
    { 0x2AB9, 0x2ABA }, { 0x2ABA, 0x2AB9 }, { 0x2ABB, 0x2ABC },
    { 0x2ABC, 0x2ABB }, { 0x2ABD, 0x2ABE }, { 0x2ABE, 0x2ABD },
    { 0x2ABF, 0x2AC0 }, { 0x2AC0, 0x2ABF }, { 0x2AC1, 0x2AC2 },
    { 0x2AC2, 0x2AC1 }, { 0x2AC3, 0x2AC4 }, { 0x2AC4, 0x2AC3 },
    { 0x2AC5, 0x2AC6 }, { 0x2AC6, 0x2AC5 }, { 0x2AC7, 0x2AC8 },
    { 0x2AC8, 0x2AC7 }, { 0x2AC9, 0x2ACA }, { 0x2ACA, 0x2AC9 },
    { 0x2ACB, 0x2ACC }, { 0x2ACC, 0x2ACB }, { 0x2ACD, 0x2ACE },
    { 0x2ACE, 0x2ACD }, { 0x2ACF, 0x2AD0 }, { 0x2AD0, 0x2ACF },
    { 0x2AD1, 0x2AD2 }, { 0x2AD2, 0x2AD1 }, { 0x2AD3, 0x2AD4 },
    { 0x2AD4, 0x2AD3 }, { 0x2AD5, 0x2AD6 }, { 0x2AD6, 0x2AD5 },
    { 0x2ADE, 0x22A6 }, { 0x2AE3, 0x22A9 }, { 0x2AE4, 0x22A8 },
    { 0x2AE5, 0x22AB }, { 0x2AEC, 0x2AED }, { 0x2AED, 0x2AEC },
    { 0x2AEE, 0x2224 }, { 0x2AF7, 0x2AF8 }, { 0x2AF8, 0x2AF7 },
    { 0x2AF9, 0x2AFA }, { 0x2AFA, 0x2AF9 }, { 0x2BFE, 0x221F },
    { 0x2E02, 0x2E03 }, { 0x2E03, 0x2E02 }, { 0x2E04, 0x2E05 },
    { 0x2E05, 0x2E04 }, { 0x2E09, 0x2E0A }, { 0x2E0A, 0x2E09 },
    { 0x2E0C, 0x2E0D }, { 0x2E0D, 0x2E0C }, { 0x2E1C, 0x2E1D },
    { 0x2E1D, 0x2E1C }, { 0x2E20, 0x2E21 }, { 0x2E21, 0x2E20 },
    ...
    { 0xFF62, 0xFF63 }, { 0xFF63, 0xFF62 }, { 0x1DB10, 0x221D },
    { 0x1DB03, 0x1DB04 }, { 0x1DB04, 0x1DB03 }, { 0x1DB05, 0x1DB06 },
    { 0x1DB06, 0x1DB05 }, { 0x1DB08, 0x1DB09 }, { 0x1DB09, 0x1DB08 },

};

#define MJB_BIDI_MIRRORING_COUNT 438
// clang-format on
...
static mjb_codepoint bidi_mirroring_glyph(mjb_codepoint cp) {
    ...
    while(lo <= hi) {
        ...
        if(mjb_bidi_mirroring[mid].cp == cp) {
            return mjb_bidi_mirroring[mid].mirror;
        }
    ...
    if(out_count > 0) {
        ...
        for(size_t i = 0; i < count; ++i) {
            if(!work[i].removed) {
                ...
                // L4: if Bidi_Mirrored and at an odd level, look up the mirroring glyph.
                if(work[i].mirrored && (work[i].level & 1)) {
                    out[k].mirroring_glyph = bidi_mirroring_glyph(work[i].codepoint);
                } else {
