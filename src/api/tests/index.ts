...
ATT_ASSERT(mojibake.stringFilter('hello    world', FilterType.COLLAPSE_SPACES), 'hello world',
  'stringFilter');
ATT_ASSERT(mojibake.codepointHasProperty(0x41, Property.CASED), true, 'codepointHasProperty');
...
ATT_ASSERT(mojibake.strnlen('H\u00E9ll\u00F6'), 5, 'strnlen');
...
ATT_ASSERT(mojibake.segmentation('A'), [BreakType.ALLOWED], 'segmentation');
...
ATT_ASSERT(mojibake.version(), '0.2.3-WASM', 'version');
ATT_ASSERT(mojibake.versionNumber(), 0x23, 'versionNumber');
