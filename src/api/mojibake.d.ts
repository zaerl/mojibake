...
export type MojibakeWasmModule = {
  ...
  _mjb_segmentation: (buffer: Pointer, byte_length: number, encoding: number, state: Pointer) => number;
  ...
  _mjb_string_is_confusable: (s1: Pointer, s1_byte_length: number, s2: Pointer, s2_byte_length: number, s1_encoding: number, s2_encoding: number) => boolean;
