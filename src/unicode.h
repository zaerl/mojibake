...
typedef enum mjb_property {
    MJB_PROPERTY_KACCOUNTINGNUMERIC, // enumerated
    MJB_PROPERTY_KOTHERNUMERIC, // enumerated
    MJB_PROPERTY_KPRIMARYNUMERIC, // enumerated
    MJB_PROPERTY_NUMERIC_VALUE, // enumerated
    MJB_PROPERTY_BIDI_MIRRORING_GLYPH, // enumerated
    MJB_PROPERTY_BIDI_PAIRED_BRACKET, // enumerated
    MJB_PROPERTY_CASE_FOLDING, // enumerated
    MJB_PROPERTY_KCOMPATIBILITYVARIANT, // enumerated
    MJB_PROPERTY_DECOMPOSITION_MAPPING, // enumerated
    MJB_PROPERTY_EQUIVALENT_UNIFIED_IDEOGRAPH, // enumerated
    MJB_PROPERTY_FC_NFKC_CLOSURE, // enumerated
    MJB_PROPERTY_LOWERCASE_MAPPING, // enumerated
    MJB_PROPERTY_NFKC_CASEFOLD, // enumerated
    MJB_PROPERTY_NFKC_SIMPLE_CASEFOLD, // enumerated
    MJB_PROPERTY_SIMPLE_CASE_FOLDING, // enumerated
    MJB_PROPERTY_SIMPLE_LOWERCASE_MAPPING, // enumerated
    MJB_PROPERTY_SIMPLE_TITLECASE_MAPPING, // enumerated
    MJB_PROPERTY_SIMPLE_UPPERCASE_MAPPING, // enumerated
    MJB_PROPERTY_TITLECASE_MAPPING, // enumerated
    MJB_PROPERTY_UPPERCASE_MAPPING, // enumerated
    MJB_PROPERTY_KIICORE, // enumerated
    MJB_PROPERTY_KIRG_GSOURCE, // enumerated
    MJB_PROPERTY_KIRG_HSOURCE, // enumerated
    MJB_PROPERTY_KIRG_JSOURCE, // enumerated
    MJB_PROPERTY_KIRG_KPSOURCE, // enumerated
    MJB_PROPERTY_KIRG_KSOURCE, // enumerated
    MJB_PROPERTY_KIRG_MSOURCE, // enumerated
    MJB_PROPERTY_KIRG_SSOURCE, // enumerated
    MJB_PROPERTY_KIRG_TSOURCE, // enumerated
    MJB_PROPERTY_KIRG_UKSOURCE, // enumerated
    MJB_PROPERTY_KIRG_USOURCE, // enumerated
    MJB_PROPERTY_KIRG_VSOURCE, // enumerated
    MJB_PROPERTY_KMANDARIN, // enumerated
    MJB_PROPERTY_KRSUNICODE, // enumerated
    MJB_PROPERTY_KTOTALSTROKES, // enumerated
    MJB_PROPERTY_KUNIHANCORE2020, // enumerated
    MJB_PROPERTY_ISO_COMMENT, // enumerated
    MJB_PROPERTY_JAMO_SHORT_NAME, // enumerated
    MJB_PROPERTY_KEH_CAT, // enumerated
    MJB_PROPERTY_KEH_DESC, // enumerated
    MJB_PROPERTY_KEH_HG, // enumerated
    MJB_PROPERTY_KEH_IFAO, // enumerated
    MJB_PROPERTY_KEH_JSESH, // enumerated
    MJB_PROPERTY_NAME, // enumerated
    MJB_PROPERTY_NAME_ALIAS, // enumerated
    MJB_PROPERTY_SCRIPT_EXTENSIONS, // enumerated
    MJB_PROPERTY_AGE, // enumerated
    MJB_PROPERTY_SCRIPT, // enumerated
    MJB_PROPERTY_BIDI_CLASS, // enumerated
    MJB_PROPERTY_BIDI_PAIRED_BRACKET_TYPE, // enumerated
    MJB_PROPERTY_CANONICAL_COMBINING_CLASS, // enumerated
    MJB_PROPERTY_DECOMPOSITION_TYPE, // enumerated
    MJB_PROPERTY_EAST_ASIAN_WIDTH, // enumerated
    MJB_PROPERTY_GENERAL_CATEGORY, // enumerated
    MJB_PROPERTY_GRAPHEME_CLUSTER_BREAK, // enumerated
    MJB_PROPERTY_HANGUL_SYLLABLE_TYPE, // enumerated
    MJB_PROPERTY_INDIC_CONJUNCT_BREAK, // enumerated
    MJB_PROPERTY_INDIC_POSITIONAL_CATEGORY, // enumerated
    MJB_PROPERTY_INDIC_SYLLABIC_CATEGORY, // enumerated
    MJB_PROPERTY_JOINING_GROUP, // enumerated
    MJB_PROPERTY_JOINING_TYPE, // enumerated
    MJB_PROPERTY_LINE_BREAK, // enumerated
    MJB_PROPERTY_NFC_QUICK_CHECK, // enumerated
    MJB_PROPERTY_NFD_QUICK_CHECK,
    MJB_PROPERTY_NFKC_QUICK_CHECK, // enumerated
    MJB_PROPERTY_NFKD_QUICK_CHECK,
    MJB_PROPERTY_NUMERIC_TYPE, // enumerated
    MJB_PROPERTY_SENTENCE_BREAK, // enumerated
    MJB_PROPERTY_VERTICAL_ORIENTATION, // enumerated
    MJB_PROPERTY_WORD_BREAK, // enumerated
    MJB_PROPERTY_ASCII_HEX_DIGIT,
    MJB_PROPERTY_ALPHABETIC,
    MJB_PROPERTY_BIDI_CONTROL,
    MJB_PROPERTY_BIDI_MIRRORED,
    MJB_PROPERTY_CASED,
    MJB_PROPERTY_COMPOSITION_EXCLUSION,
    MJB_PROPERTY_CASE_IGNORABLE,
    MJB_PROPERTY_FULL_COMPOSITION_EXCLUSION,
    MJB_PROPERTY_CHANGES_WHEN_CASEFOLDED,
    MJB_PROPERTY_CHANGES_WHEN_CASEMAPPED,
    MJB_PROPERTY_CHANGES_WHEN_NFKC_CASEFOLDED,
    MJB_PROPERTY_CHANGES_WHEN_LOWERCASED,
    MJB_PROPERTY_CHANGES_WHEN_TITLECASED,
    MJB_PROPERTY_CHANGES_WHEN_UPPERCASED,
    MJB_PROPERTY_DASH,
    MJB_PROPERTY_DEPRECATED,
    MJB_PROPERTY_DEFAULT_IGNORABLE_CODE_POINT,
    MJB_PROPERTY_DIACRITIC,
    MJB_PROPERTY_EMOJI_MODIFIER_BASE,
    MJB_PROPERTY_EMOJI_COMPONENT,
    MJB_PROPERTY_EMOJI_MODIFIER,
    MJB_PROPERTY_EMOJI,
    MJB_PROPERTY_EMOJI_PRESENTATION,
    MJB_PROPERTY_EXTENDER,
    MJB_PROPERTY_EXTENDED_PICTOGRAPHIC,
    MJB_PROPERTY_GRAPHEME_BASE,
    MJB_PROPERTY_GRAPHEME_EXTEND,
    MJB_PROPERTY_GRAPHEME_LINK,
    MJB_PROPERTY_HEX_DIGIT,
    MJB_PROPERTY_HYPHEN,
    MJB_PROPERTY_ID_COMPAT_MATH_CONTINUE,
    MJB_PROPERTY_ID_COMPAT_MATH_START,
    MJB_PROPERTY_ID_CONTINUE,
    MJB_PROPERTY_IDEOGRAPHIC,
    MJB_PROPERTY_ID_START,
    MJB_PROPERTY_IDS_BINARY_OPERATOR,
    MJB_PROPERTY_IDS_TRINARY_OPERATOR,
    MJB_PROPERTY_IDS_UNARY_OPERATOR,
    MJB_PROPERTY_JOIN_CONTROL,
    MJB_PROPERTY_KEH_NOMIRROR,
    MJB_PROPERTY_KEH_NOROTATE,
    MJB_PROPERTY_LOGICAL_ORDER_EXCEPTION,
    MJB_PROPERTY_LOWERCASE,
    MJB_PROPERTY_MATH,
    MJB_PROPERTY_MODIFIER_COMBINING_MARK,
    MJB_PROPERTY_NONCHARACTER_CODE_POINT,
    MJB_PROPERTY_OTHER_ALPHABETIC,
    MJB_PROPERTY_OTHER_DEFAULT_IGNORABLE_CODE_POINT,
    MJB_PROPERTY_OTHER_GRAPHEME_EXTEND,
    MJB_PROPERTY_OTHER_ID_CONTINUE,
    MJB_PROPERTY_OTHER_ID_START,
    MJB_PROPERTY_OTHER_LOWERCASE,
    MJB_PROPERTY_OTHER_MATH,
    MJB_PROPERTY_OTHER_UPPERCASE,
    MJB_PROPERTY_PATTERN_SYNTAX,
    MJB_PROPERTY_PATTERN_WHITE_SPACE,
    MJB_PROPERTY_PREPENDED_CONCATENATION_MARK,
    MJB_PROPERTY_QUOTATION_MARK,
    MJB_PROPERTY_RADICAL,
    MJB_PROPERTY_REGIONAL_INDICATOR,
    MJB_PROPERTY_SOFT_DOTTED,
    MJB_PROPERTY_SENTENCE_TERMINAL,
    MJB_PROPERTY_TERMINAL_PUNCTUATION,
    MJB_PROPERTY_UNIFIED_IDEOGRAPH,
    MJB_PROPERTY_UPPERCASE,
    MJB_PROPERTY_VARIATION_SELECTOR,
    MJB_PROPERTY_WHITE_SPACE,
    MJB_PROPERTY_XID_CONTINUE,
    MJB_PROPERTY_XID_START,
    MJB_PROPERTY_EXPANDS_ON_NFC,
    MJB_PROPERTY_EXPANDS_ON_NFD,
    MJB_PROPERTY_EXPANDS_ON_NFKC,
    MJB_PROPERTY_EXPANDS_ON_NFKD
} mjb_property;

#define MJB_PROPERTY_COUNT 143
